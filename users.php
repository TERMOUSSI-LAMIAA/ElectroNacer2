...
$queryApproved = "SELECT * FROM utilisateur WHERE is_approved = true";
                                ...
                                <td>
                                    <button class="approve-button" onclick="">
                                        <img src="assets/images/accept-check-good-mark-ok-tick-svgrepo-com.svg"
                                            alt="approve Icon" width="20" height="20">
                                    </button>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="admin-button" onclick="">
                                        <img src="assets/images/admin-1-svgrepo-com.svg" alt="beadmin Icon" width="20"
                                            height="20">
                                    </button>
                                </td>
                                <!-- Add other relevant columns -->
